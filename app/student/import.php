...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="<?php echo $baseurl; ?>app/student/index.php">Student View</a>
	</li>
	<li class="breadcrumb-item active">Student Import</li>
</ol>
<div class="card mb-3">
	<div class="card-header">
		Student <small>Import</small>
	</div>
	<div class="card-body">
...
if (isset($_POST['btnImport']) && isset($_POST['filePath'])) {
	...
	$values = rtrim($values, ',');
	$query .= "INSERT INTO student (" . $columnName . ") Values " . $columnValues . "";
...
?>
	<div class="card mb-3">
		<div class="card-header">
			<form method='POST'>
				Verify Data
				<input type="hidden" name="columnCount" value="8" />
		...
		<div class="card-body">
			...
			if (in_array($_FILES["file"]["type"], $mimes)) {
				...
				$tableColumnList = ['first_name','middle_name','last_name','guardian_name','guardian_ph','house_id','form_id','photo_id'];
				$count = 0;
