...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="<?php echo $baseurl; ?>app/exeat/index.php">Exeat View</a>
	</li>
	<li class="breadcrumb-item active">Exeat Import</li>
</ol>
<div class="card mb-3">
	<div class="card-header">
		Exeat <small>Import</small>
	</div>
	<div class="card-body">
...
if (isset($_POST['btnImport']) && isset($_POST['filePath'])) {
	...
	$values = rtrim($values, ',');
	$query .= "INSERT INTO exeat (" . $columnName . ") Values " . $columnValues . "";
...
?>
	<div class="card mb-3">
		<div class="card-header">
			<form method='POST'>
				Verify Data
				<input type="hidden" name="columnCount" value="5" />
		...
		<div class="card-body">
			...
			if (in_array($_FILES["file"]["type"], $mimes)) {
				...
				$tableColumnList = ['student_id','reason','start_date','end_date','status'];
				$count = 0;
