...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="<?php echo $baseurl; ?>app/house/index.php">House View</a>
	</li>
	<li class="breadcrumb-item active">House Import</li>
</ol>
<div class="card mb-3">
	<div class="card-header">
		House <small>Import</small>
	</div>
	<div class="card-body">
...
if (isset($_POST['btnImport']) && isset($_POST['filePath'])) {
	...
	$values = rtrim($values, ',');
	$query .= "INSERT INTO house (" . $columnName . ") Values " . $columnValues . "";
